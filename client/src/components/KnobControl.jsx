...
const KnobControl = ({ indicator, setValue, customStyle }) => {
  ...
  return (
    <svg aria-hidden="true" className={`inline overflow-visible w-[60px] h-[60px]  text-gray-500 ${customStyle}`}  viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle className='hover:cursor-move z-50' ref={draggableRef} cx={dx} cy={dy} r={window.innerWidth<=400 ? '30' : '10'} />
    </svg>
  )
}
